...
{
    /// <summary>
    ///     The token uses the default behavior depending on the type of token. A token that contains
    ///     a CustomValues list will pad right. A token that is a numeric type will pad left.
    /// </summary>
    Default = 0,
